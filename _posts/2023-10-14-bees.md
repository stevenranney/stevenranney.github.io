---
layout: post
title: "Exploring some MT bees data because why not?"
date: 2023-10-14
...
This is an `.ipynb` file I converted to md with `jupyter nbconvert` but there was still some special handling involved to get this into github pages correctly.

Let's try something elese, too.
